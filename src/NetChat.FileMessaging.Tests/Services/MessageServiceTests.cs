...
namespace NetChat.FileMessaging.Tests.Services
{
    ...
    {
        private IFileMessageService _messageService;
        ...
        {
            var sendingMessageData = new InputMessageData("Text", "01.01.2020 11:22:33|USER2");
        ...
        public void SendMessage_MessageIsNull_ThrowArgumentNullException()
        {
            Assert.ThrowsAsync<ArgumentNullException>(() 
                => _messageService.SendMessage(new InputMessageData(null, null)));
        ...
        public void SendMessage_ReplyIdHasWrongFormat_ThrowFormatException()
        {
            Assert.ThrowsAsync<FormatException>(() 
                => _messageService.SendMessage(new InputMessageData("Text", "BADREPLY")));
            _repositoryMock.Verify(
                m => m.AddAsync(It.IsAny<MessageDataEntity>()),
                Times.Never);
        }
